            ...
            },
            {
                ...
                cards: [
                    ...
                    },
                    {
                        ...
                        route: "/admin/models",
                        owner: "Model routing",
                        purpose: "Default A-E and user-created character profiles for chat, TTS, ASR, Live2D selection, API keys, and local model base URLs.",
                    },
                    {
                        label: "Channels",
                        route: "/admin/channels",
                        owner: "Messaging gateways",
                        purpose: "Runtime channel status and setup boundaries for Telegram, QQ, LINE, Discord, WhatsApp, and later adapters.",
                    },
                    {
            ...
            },
            {
                ...
                cards: [
                    ...
                    },
                    {
                        ...
                        route: "/api/model-profiles*, /api/channels*, /api/openwebui/*, /api/health",
                        owner: "Back office",
                        purpose: "Model profile persistence, messaging channel config/status, Open WebUI bridge tools, health checks, and protected docs.",
                    },
                ],
            },
            {
                ...
                items: [
                    ...
                    "External channel gateways such as Telegram, LINE, Discord, and WhatsApp should start in `/admin/channels`, then be wired to runtime adapters.",
                ],
            },
        ],
    },
            ...
            },
            {
                ...
                cards: [
                    ...
                    },
                    {
                        ...
                        route: "/admin/models",
                        owner: "模型路由",
                        purpose: "預設 A-E 與使用者新增的角色 profile；管理 chat、TTS、ASR、Live2D 選擇、API key 與地端模型 base URL。",
                    },
                    {
                        label: "通訊平台",
                        route: "/admin/channels",
                        owner: "Messaging gateways",
                        purpose: "Telegram、QQ、LINE、Discord、WhatsApp 與後續 adapter 的 runtime channel 狀態與設定邊界。",
                    },
                    {
                        label: "Open WebUI Bridge",
                        route: "/admin/openwebui",
            ...
            },
            {
                ...
                cards: [
                    ...
                    },
                    {
                        ...
                        route: "/api/model-profiles*, /api/channels*, /api/openwebui/*, /api/health",
                        owner: "後台",
                        purpose: "模型 profile、通訊平台 config/status、Open WebUI bridge tools、health checks 與 protected docs。",
                    },
                ],
            },
            {
                ...
                items: [
                    ...
                    "Telegram、LINE、Discord、WhatsApp 等外部通道先進 `/admin/channels`，再接 runtime adapter。",
                ],
            },
        ],
    },
            ...
            },
            {
                ...
                cards: [
                    ...
                    },
                    {
                        ...
                        route: "/admin/models",
                        owner: "模型路由",
                        purpose: "默认 A-E 与用户新增的角色 profile；管理 chat、TTS、ASR、Live2D 选择、API key 与地端模型 base URL。",
                    },
                    {
                        label: "通讯平台",
                        route: "/admin/channels",
                        owner: "Messaging gateways",
                        purpose: "Telegram、QQ、LINE、Discord、WhatsApp 与后续 adapter 的 runtime channel 状态与设置边界。",
                    },
                    {
                        label: "Open WebUI Bridge",
                        route: "/admin/openwebui",
            ...
            },
            {
                ...
                cards: [
                    ...
                    },
                    {
                        ...
                        route: "/api/model-profiles*, /api/channels*, /api/openwebui/*, /api/health",
                        owner: "后台",
                        purpose: "模型 profile、通讯平台 config/status、Open WebUI bridge tools、health checks 与 protected docs。",
                    },
                ],
            },
            {
                ...
                items: [
                    ...
                    "Telegram、LINE、Discord、WhatsApp 等外部通道先进 `/admin/channels`，再接 runtime adapter。",
                ],
            },
        ],
    },
