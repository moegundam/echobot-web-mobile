...
class WebStaticAssetTests(unittest.TestCase):
    def test_display_mode_uses_layout_mode_contract(self) -> None:
        ...
        self.assertIn('document.querySelectorAll("[data-display-mode-switcher]")', display_mode_js)
        self.assertIn('document.createElement("button")', display_mode_js)
        self.assertIn('button.setAttribute("aria-haspopup", "listbox")', display_mode_js)
        self.assertIn('menu.setAttribute("role", "listbox")', display_mode_js)
        self.assertIn('className = "shell-display-mode-menu"', display_mode_js)
        self.assertIn('className = "shell-display-mode-option"', display_mode_js)
        self.assertNotIn('document.createElement("select")', display_mode_js)
    ...
    def test_console_exposes_role_model_profile_and_control_groups(self) -> None:
        ...
        self.assertIn('button.setAttribute("aria-haspopup", "listbox")', i18n_js)
        self.assertIn('menu.setAttribute("role", "listbox")', i18n_js)
        self.assertIn('className = "shell-language-menu"', i18n_js)
        self.assertIn('className = "shell-language-option"', i18n_js)
        self.assertNotIn('document.createElement("select")', i18n_js)
        ...
        self.assertIn("grid-template-columns: auto minmax(0, 1fr)", responsive_css)
        self.assertIn(".model-profile-manage-link", responsive_css)
        self.assertNotIn("width: 100vw", responsive_css)
    ...
    def test_messenger_stage_stream_contract_is_explicit(self) -> None:
        ...
        self.assertIn("void refreshStageContext({ reloadLive2D: true });", stage_js)
        ...
        self.assertIn('"stage.sessionTarget": "Session"', i18n_js)
        self.assertIn('"stage.sessionTarget": "場次"', i18n_js)
        self.assertIn('"stage.sessionTarget": "场次"', i18n_js)
        self.assertIn('"messenger.sessionTarget": "Session"', i18n_js)
        self.assertIn('"messenger.sessionTarget": "場次"', i18n_js)
        self.assertIn('"messenger.sessionTarget": "场次"', i18n_js)
    ...
    def test_session_centered_admin_model_pages_are_split(self) -> None:
        ...
        self.assertIn('shell-pages.css?v=ux-public-2', openwebui_html)
        self.assertIn('shell-pages.css?v=ux-public-2', guide_html)
        self.assertIn('deployment-app.js?v=deployment-2', deployment_html)
        self.assertIn('"/api/deployment/status"', deployment_js)
        self.assertIn('shell-i18n.js?v=ux-public-1', deployment_js)
        self.assertIn('shell-i18n.js?v=ux-public-1', admin_js)
        self.assertIn('shell-i18n.js?v=ux-public-1', openwebui_js)
        self.assertIn('admin-app.js?v=ux-public-1', admin_html)
        self.assertIn('openwebui-app.js?v=ux-public-1', openwebui_html)
        self.assertIn("safeHealthSnapshot", admin_js)
        self.assertNotIn("JSON.stringify(payload, null, 2)", admin_js)
